...
define('MF_REPAIR_VERSION', '5.0.0');
define('MF_TARGET_VERSION', '10.5.0');
    ...
    <div class="mf-wrap">
        ...
        <div class="mf-github-bar <?php echo $github_status['has_updates'] ? 'has-updates' : ($github_status['error'] ? '' : 'up-to-date'); ?>">
            ...
            <div>
                ...
                <a href="<?php echo admin_url('admin.php?page=mf-auto-repair&apply_updates=1'); ?>" class="mf-github-btn">⬇️ Télécharger</a>
                <?php else: ?>
